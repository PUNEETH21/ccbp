...
class AppStore extends Component {
  ...
  render() {
    ...
    const selectedAppList = appsList.filter(
      appItem =>
        appItem.category === activeTabId &&
        appItem.appName.toLowerCase().includes(inputSearch.toLowerCase()),
    )
